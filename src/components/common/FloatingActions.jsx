    ...
    return (
        <div className="fixed bottom-24 right-4 md:bottom-8 md:right-8 z-50 flex flex-col gap-3">
            ...
            <a
                ...
                className="flex items-center gap-2 bg-white text-primary-dark p-2 pr-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-x-1 group border border-gray-100"
            >
                ...
                <span className="font-bold text-sm">Tư vấn khóa học</span>
            </a>
            ...
            >
                ...
                <span className="font-bold text-sm">Chuẩn bệnh miễn phí</span>
            </a>
